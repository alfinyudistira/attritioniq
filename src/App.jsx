...
const MODULES = [
  ...
  { id: "m2", label: "Predictive Risk Scorer", icon: "🎯", short: "M2", live: false },
  { id: "m3", label: "Salary Benchmarking", icon: "💰", short: "M3", live: false },
  { id: "m4", label: "Dept Health Monitor", icon: "🏥", short: "M4", live: false },
  { id: "m5", label: "Exit Interview Analyzer", icon: "🚪", short: "M5", live: false },
  { id: "m6", label: "Retention ROI Calc", icon: "📈", short: "M6", live: false },
